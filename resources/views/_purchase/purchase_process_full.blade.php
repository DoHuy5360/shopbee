    ...
    <div id="profile-body-tranfer-wrap">
        <div id="profile-process-wrap">
            <div id="profile-process-bar-wrap">
                <div data-type="all" class="profile__process-navbar-btn active_link">Tất cả</div>
                <div data-type="wait_confirm" class="profile__process-navbar-btn">Chờ xác nhận</div>
                <div data-type="wait_get" class="profile__process-navbar-btn">Chờ lấy hàng</div>
                <div data-type="delivering" class="profile__process-navbar-btn">Đang giao</div>
                <div data-type="delivered" class="profile__process-navbar-btn">Đã giao</div>
                <div data-type="cancel" class="profile__process-navbar-btn">Đã Hủy</div>
                <div data-type="refund" class="profile__process-navbar-btn">Trả hàng/Hoàn tiền</div>
            </div>
