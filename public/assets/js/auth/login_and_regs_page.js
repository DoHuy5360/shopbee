...
function AutoGradient() {
    const color2 = color1;
    color1 = randomColor();
    getLoginBg.style.background = "linear-gradient( 270deg," + color2 + "," + color1 + ")";
    getRegsBg.style.background = "linear-gradient( 270deg," + color2 + "," + color1 + ")";
}
